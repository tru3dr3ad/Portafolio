...
DROP PROCEDURE SP_MONEDA_CAMBIO;
...
BEGIN 
    ...
    SELECT STOCK INTO STOCKNUMERO FROM PRODUCTO WHERE CODIGO = :NEW.PRODUCTO_CODIGO;
    IF  STOCKNUMERO = 0 THEN
        UPDATE PRODUCTO SET ESTADO = '0' WHERE CODIGO = :NEW.PRODUCTO_CODIGO;
    END IF;
END;
